...
parser.add_argument(
    ...
    "--project_id",
    help=
    "project id associated with a project that has permission for google cloud services",
...
def main(project_id: str, image_path: str, destination: str, font_path: str,
         font_model_path: str, bound_model_path: str):
    """
    ...
    assign_obj = assign_ml.load_default_model(font_model_path,
                                              bound_model_path)
...
if __name__ == '__main__':
    ...
    main(args.project_id, args.file_path, args.output, args.font_path,
         args.model_font_size, args.model_bounding_box)
