...
class AddCoords(nn.Module):
    def __init__(self, rank, with_r=False, use_cuda=True):
        """
        Adds additional channels of the same size of the input channel that add X [0 to 1]^2 and Y[0 to1]^2 (as well as cross multiplication)
         values to provide positional context when convolutions are applied
          very mariginally modified from one page https://github.com/walsvid/CoordConv
    ...
    def forward(self, input_tensor):
        """
        takes in a channel and adds positional information to those channels
        Args:
