...
if __name__ == '__main__':
    ...
    automl = autosklearn.regression.AutoSklearnRegressor(
        ...
        tmp_folder='/tmp/autosklearn_regression_result1',
        output_folder='/tmp/autosklearn_regression_result1_out',
    )

    final_model=automl.fit(x_train, y_train, dataset_name="do massive feature sweep")
    print("OK")
