...
if __name__ == '__main__':
    ...
    print(type(image))
    # results typically from another model
    actual_results_pd: str = pd.read_csv(results_path, sep="\t", index_col=0)
    ...
    aML.set_font_model(m1)
    aML.set_location_model(m2)
    result_data = aML.assign_all(
        image,
        actual_results_pd.translation.values,
        actual_results_pd,
        actual_font_path)
